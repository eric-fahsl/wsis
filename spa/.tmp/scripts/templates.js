...
this["JST"]["app/scripts/templates/all-resorts.hbs"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  buffer += "\n<div class=\"col-md-2 stateDisplay\"><h3>"
    + escapeExpression(((stack1 = depth0.state),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</h3>\n";
  stack2 = helpers.each.call(depth0, depth0.resorts, {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n</div>\n";
  options = {hash:{},data:data};
  stack2 = ((stack1 = helpers.printDivider || depth0.printDivider),stack1 ? stack1.call(depth0, ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.index), options) : helperMissing.call(depth0, "printDivider", ((stack1 = data),stack1 == null || stack1 === false ? stack1 : stack1.index), options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n";
  return buffer;
  }
function program2(depth0,data) {
  ...
  buffer += "\n";
  stack1 = helpers.each.call(depth0, depth0.resorts, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
...
function program5(depth0,data) {
  ...
  buffer += escapeExpression(stack2)
    + "/";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.addDaysToDate || depth0.addDaysToDate),stack1 ? stack1.call(depth0, depth0.date, -1, options) : helperMissing.call(depth0, "addDaysToDate", depth0.date, -1, options)))
    + "\">Previous Day</a></span> |\n    <span class=\"ital\"><a href=\"#/resort/";
  if (stack2 = helpers.resort) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.resort; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
