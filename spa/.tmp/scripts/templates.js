...
this["JST"]["app/scripts/templates/myview.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["app/scripts/templates/reccDetailsView.ejs"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2>' +
((__t = ( resort_name )) == null ? '' : __t) +
', ' +
((__t = ( state )) == null ? '' : __t) +
