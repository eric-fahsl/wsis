...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"x\" id=\"X_<%=term%>\">X</div>\n<a href=\"/<%=url%>\"><%=displayValue%></a>";
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div style=\"clear:both;\"></div>\n<h5><a href=\"http://whereshouldiski.com<%=url%>\"><%=prettyDate%></a></h5>\n";
  });
...
], function ($, _, Backbone, JST, AboutView, FeedbackView) {
    'use strict';
...
define("../bower_components/sass-bootstrap/dist/js/bootstrap", function(){});
...
require([
    'backbone', 'routers/router', '../bower_components/sass-bootstrap/dist/js/bootstrap'
